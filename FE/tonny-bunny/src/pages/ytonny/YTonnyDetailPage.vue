        ...
        <div class="yTonnyDetailWrap customForm col-md-6 col-12" ref="yTonnyDetail">
            ...
            >
                ...
                <div class="infos">
                    <div class="tag">
                        <div>
                            <square-tag sub :text="getTaskCode" class="me-2"></square-tag>
                        </div>
                        <div v-if="getTaskStateCode == taskStateCode[0].name">
                            <square-tag :text="getTaskStateCode" success></square-tag>
                        </div>
                        <div v-else-if="getTaskStateCode == taskStateCode[1].name">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <div v-else>{{ yTonnyDetail.content }}</div>
                                    </td>
                                </tr>
                            </tbody>
                        </v-table>
                                        ...
                                        <div class="col-10 helperInfo">
                                            ...
                                            <div class="d-flex infoss justify-space-around">
                                                <div>
                                                    ...
                                                    {{
                                                        apply.helper.helperInfo.reviewCount != 0
                                                            ? (
                                                                  apply.helper.helperInfo
                                                                      .totalScore /
                                                                  apply.helper.helperInfo
                                                                      .reviewCount
                                                              ).toFixed(1)
    ...
    computed: {
        ...
        getStartLangCode() {
            ...
            this.langCode.forEach((e) => {
                if (e.value == this.yTonnyDetail.startLangCode) code = e.name;
            });
            return code;
        },
        getEndLangCode() {
            let code;
            this.langCode.forEach((e) => {
                if (e.value == this.yTonnyDetail.endLangCode) code = e.name;
            });
            return code;
        },
        getTaskCode() {
            ...
            this.taskCode.forEach((e) => {
                if (e.value == this.yTonnyDetail.taskCode) code = e.name;
            });
            return code;
        },
        getTaskStateCode() {
            let code;
            this.taskStateCode.forEach((e) => {
                if (e.value == this.yTonnyDetail.taskStateCode) code = e.name;
            });
            return code;
        },
        getTonnySituCode() {
...
>>>>>>> 69073dc7028a571340e76b324f6ac574bff918d8
        ...
        async insertYTonnyApply() {
            ...
            // console.log("detail:", this.yTonnyDetail);
        ...
        async acceptYTonnyApply(yTonnyApplySeq, helperSeq, unitPrice) {
            ...
            let clientAlert = {
                ...
                taskCode: this.yTonnyDetail.taskCode,
                title: this.yTonnyDetail.title,
                content: '"' + this.yTonnyDetail.title + '"건 신청을 수락했습니다.',
                yTonnySeq: this.yTonnyDetail.seq,
                clientNickname: this.yTonnyDetail.client.nickName,
